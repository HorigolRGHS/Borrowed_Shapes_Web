      ...
      <AuthCard title={t("auth.google_complete_title")} logo={<AuthLogo />}>
        <div className="space-y-6 text-center py-6">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-lg text-gray-200 font-orbitron">{t("auth.google_deeplink_opening")}</h3>
          ...
          <button 
            type="button"
            className="w-full py-3 rounded-xl border border-[#1e1e3a] hover:border-gray-500 bg-white/5 hover:bg-white/10 text-white transition-all duration-200 font-sans font-medium mt-4" 
  ...
  return (
    <AuthCard title={t("auth.google_complete_title")} logo={<AuthLogo />}>
      <div className="space-y-5">
        ...
        {loginCode && (
          <div className="flex flex-col gap-4 items-stretch">
            <div className="relative">
              <pre className="w-full text-center tracking-widest text-xl font-bold bg-white/5 border border-[#1e1e3a] hover:border-gray-600 focus:border-amber-500 rounded-xl py-4 px-4 text-amber-400 outline-none transition-colors overflow-x-auto shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                {loginCode}
              </pre>
            </div>
            <button 
        ...
        <Link 
          href="/"
          className="w-full mt-4 py-3 rounded-xl border border-[#1e1e3a] hover:border-gray-500 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white transition-all duration-200 flex items-center justify-center font-sans text-sm font-medium"
        >
