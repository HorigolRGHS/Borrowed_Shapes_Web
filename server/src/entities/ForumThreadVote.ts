...
export class ForumThreadVote {
  ...
  @Index({ name: 'ForumThreadVote_threadId_idx', expression: 'CREATE INDEX "ForumThreadVote_threadId_idx" ON web."ForumThreadVote" USING btree ("threadId")' })
  @ManyToOne({ entity: () => ForumThread, fieldName: 'threadId', deleteRule: 'cascade', primary: true })
