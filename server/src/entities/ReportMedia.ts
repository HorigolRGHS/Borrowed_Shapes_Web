...
export class ReportMedia {
  ...
  @Index({ name: 'ReportMedia_reportId_idx', expression: 'CREATE INDEX "ReportMedia_reportId_idx" ON web."ReportMedia" USING btree ("reportId")' })
  @ManyToOne({ entity: () => Report, fieldName: 'reportId', deleteRule: 'cascade' })
  reportId!: Report;
